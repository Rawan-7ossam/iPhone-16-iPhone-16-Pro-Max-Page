...
export default function Navbar() {
  ...
  const navLinks = ["Switch from Android to iPhone", "Tech Specs"];
  ...
  return (
    <>
        ...
        animate={{
          height:
            window.innerWidth >= 1024 // lg breakpoint
              ? "8vh" // على الشاشات الكبيرة يفضل ثابت
              : dropdownBtn
              ? isLandscape
                ? "57vh" // لو landscape ومعمول expand
                : "30vh" // لو portrait ومعمول expand
              : isLandscape
              ? "19vh" // landscape عادي
              : "8vh",
        }} // بطول الناف بار و اقصره
      ...
      >
        <div className="navbar shadow-sm justify-between w-full  lg:w-[60%] m-auto relative">
          {/* اللوجو */}
          <div>
          ...
          >
            <ul className="menu menu-horizontal px-1 text-[#cbc9c9] py-0">
              <li>
                <a className="hover:text-white cursor-pointer">Overview</a>
              </li>
              {navLinks.map((link) => (
                <li key={link}>
